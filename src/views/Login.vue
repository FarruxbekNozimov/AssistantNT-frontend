      ...
      >
        <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
          <div class="text-center w-full">
            <img
              class="w-32 h-32 mx-auto mb-5 rounded-full"
          ...
          <form class="space-y-4 md:space-y-6" action="#">
            ...
            <button
              type="submit"
              class="w-full text-white border border-gray-700 bg-gray-600 hover:bg-gray-800 focus:ring-4 focus:outline-none focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center duration-300"
            >
              Kirish
            </button>
          </form>
